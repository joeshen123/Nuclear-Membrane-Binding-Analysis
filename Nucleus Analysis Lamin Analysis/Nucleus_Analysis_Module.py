...
def Napari_Viewer(structure_img_smooth,intensity_image_stack_raw,intensity_image_stack,segmented_object_image,bw_img,filament_image,skeleton_image, seed_map_list,branch_point_list,contour_image_crop,segmented_image_crop,track_points,track_table,x,y,z):
    # Visualize in Napari
