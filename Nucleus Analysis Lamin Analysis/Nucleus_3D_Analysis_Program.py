from Nucleus_Analysis_Module import *
...
#Visualize in Napari
Napari_Viewer(track.image,track.structure_img_smooth, Segment_tracker.intensity_image_stack_raw, Segment_tracker.intensity_image_stack, track.segmented_object_image, track.bw_img, Segment_tracker.filament_image_crop,
...
while del_answer == True:
   ...
   Napari_Viewer(track.image,track.structure_img_smooth, Segment_tracker.intensity_image_stack_raw,
...
plotting(track_table,marker='o',saving=True)
